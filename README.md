...
The purpose of this code is to gather a list of shortcuts on desktop or start menu, and also show the path to the program behind each link.  This can be useful when modifying batch shortcuts behavior.
...
Grabs the identity zip, and processes it for a new node identity.
